<!-- pages/dashboard.vue -->
<template>
  <div class="min-h-screen bg-slate-50/80 text-slate-800 antialiased font-sans">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-xl font-black tracking-tight text-[#FFCC00]">
              MIS Queueing Dashboard
            </h1>
            <p class="text-xs text-emerald-100/80 font-medium">
              Real-time Completed Services Overview
            </p>
          </div>
        </div>

        <!-- Quick Refresh & Actions Bar -->
        <div class="flex items-center gap-3">
          <button
            @click="handleRefresh"
            :disabled="pending"
            class="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-semibold rounded-lg bg-emerald-900/60 hover:bg-emerald-800/80 text-emerald-100 border border-emerald-700/50 transition-all focus:outline-none focus:ring-2 focus:ring-[#FFCC00] disabled:opacity-50"
...
// 6. Visual Theme Mapping per Category
